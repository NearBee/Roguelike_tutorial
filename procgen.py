...
class RectangularRoom:
    ...
    def inner(self) -> Tuple[slice, slice]:
        """Return the inner area of this room in a 2D array index"""
...
def generate_dungeon(
    ...
    for r in range(max_rooms):
        ...
        if any(new_room.intersects(other_room) for other_room in rooms):
            continue  # This room intersects, so go on to another attempt.
        # if there are no interesections then the room is valid.
